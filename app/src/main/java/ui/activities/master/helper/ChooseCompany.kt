...
import com.vsg.helper.ui.widget.spinner.choose.ChooseIEntitySpinnerWithOutParameter
import com.vsg.ot.R
...
class ChooseCompany(app: BaseActivity) :
    ChooseIEntitySpinnerWithOutParameter<MasterCompany, MasterCompanyViewModel>(
        app,
