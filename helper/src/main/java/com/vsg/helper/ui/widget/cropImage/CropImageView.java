package com.vsg.helper.ui.widget.cropImage;
...
import com.vsg.helper.ui.widget.cropImage.animation.SimpleValueAnimator;
import com.vsg.helper.ui.widget.cropImage.animation.SimpleValueAnimatorListener;
import com.vsg.helper.ui.widget.cropImage.animation.ValueAnimatorV14;
import com.vsg.helper.ui.widget.cropImage.animation.ValueAnimatorV8;
import com.vsg.helper.ui.widget.cropImage.callback.Callback;
import com.vsg.helper.ui.widget.cropImage.callback.CropCallback;
import com.vsg.helper.ui.widget.cropImage.callback.LoadCallback;
import com.vsg.helper.ui.widget.cropImage.callback.SaveCallback;
import com.vsg.helper.ui.widget.cropImage.util.Logger;
import com.vsg.helper.ui.widget.cropImage.util.Utils;
...
@SuppressWarnings("unused") public class CropImageView extends androidx.appcompat.widget.AppCompatImageView {
  ...
  private void handleStyleable(Context context, AttributeSet attrs, int defStyle, float mDensity) {
    ...
    try {
      ...
      mFrameStrokeWeight =
          ta.getDimensionPixelSize(R.styleable.scv_CropImageView_scv_frame_stroke_weight,
              (int) (FRAME_STROKE_WEIGHT_IN_DP * mDensity));
      mGuideStrokeWeight =
          ta.getDimensionPixelSize(R.styleable.scv_CropImageView_scv_guide_stroke_weight,
